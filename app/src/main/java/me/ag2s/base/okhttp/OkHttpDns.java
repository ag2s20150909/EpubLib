...
public class OkHttpDns implements Dns {
    ...
    public List<InetAddress> lookup(String hostname) throws UnknownHostException {
        ...
        String ip = null;
        //直接返回DNSIP
        if (hostname.equals("dns.alidns.com")) {
            List<InetAddress> inetAddresses = new ArrayList<>();
            inetAddresses.addAll(Arrays.asList(InetAddress.getAllByName("223.5.5.5")));
            inetAddresses.addAll(Arrays.asList(InetAddress.getAllByName("223.6.6.6")));
