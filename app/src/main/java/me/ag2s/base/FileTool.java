...
public class FileTool {
    ...
    public static final String BASEPATH = APP.getContext().getExternalFilesDir("").getPath();
    ...
    public static String readFile(String t, String base, String filename) {
        String path = t + "/" + base;
        try {
            File f = new File(t);
            if (!f.exists()) {
    ...
    public static void combine1(String name, String filename, String content) {
        String path = BASEPATH + "/" + name;
        try {
            File f = new File(BASEPATH);
            if (!f.exists()) {
